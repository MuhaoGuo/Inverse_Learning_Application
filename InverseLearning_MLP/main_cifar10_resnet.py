...
parser.add_argument('--save_dir', default="mlp_resnet_cifar10_39block_200epoch/", type=str, help='directory to save results') # mnist cifar10
...
for batch_idx, (inputs, targets) in enumerate(trainloader):
    ...
    if use_cuda:
        inputs, tragets  = inputs.cuda(), targets.cuda()
