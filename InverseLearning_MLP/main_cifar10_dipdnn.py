...
parser = argparse.ArgumentParser(description='Train DipDNN on Cifar-10')
parser.add_argument('--save_dir', default="./mlp_DipDNN_cifar10_12block_200epoch", type=str, help='directory to save results') # mnist cifar10
...
parser.add_argument('--nStrides', nargs='+', type=int, default=[1, 2, 2])   #  useless 1, 2, 2  / 1, 0, 0
parser.add_argument('--nChannels', nargs='+', type=int, default=[16, 64, 256]) # useless 16, 64, 256
