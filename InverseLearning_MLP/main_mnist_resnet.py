...
from mlp_ResNet import mlp_ResNet as ResNet
...
parser.add_argument('--save_dir', default="mlp_resnet_mnist_2block_100epoch_adam", type=str, help='directory to save results') # mnist cifar10
...
parser.add_argument('--optimizer', default="adam", type=str, help="optimizer", choices=["adam", "adamax", "sgd"])
...
parser.add_argument('--nBlocks', nargs='+', type=int, default=[1, 1, 0])   # 4, 4, 4   / 1, 0, 0
...
for batch_idx, (inputs, targets) in enumerate(trainloader):
    ...
    mse_inverse = criterion_inverse(inputs, x_re_reshaped).item()  # not inputs_repeated but inputs
