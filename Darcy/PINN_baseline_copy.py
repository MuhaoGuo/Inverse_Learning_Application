...
num_steps = 1000
pde_weight = 1.0
data_weight = 10000 # 10000
model_name = "PINN_Darcy_baseline_dataweight10000_hiddenmatch"
t0 = time.time()
...
num_steps = 1000
pde_weight = 1.0
data_weight = 100.0 # 10000
model_name = "PINN_Darcy_baseline_dataweight100_hiddenmatch"
t0 = time.time()
