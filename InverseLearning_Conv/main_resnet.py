...
parser.add_argument('--save_dir', default="./resnet_cifar10_12block_200epoch_test", type=str, help='directory to save results') # mnist cifar10
...
fixedPrior = False
nonlin = 'elu'
model = ResNet(nBlocks=args.nBlocks,
